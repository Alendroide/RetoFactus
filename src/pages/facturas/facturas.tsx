    ...
    <DefaultLayout>
      ...
      <div className="flex space-x-4">
        <div className="w-1/4 space-y-4">
            ...
            <Select
              ...
              classNames={{
                ...
                trigger: "bg-gray-900 text-white border-gray-700",
                value: "text-white",
              }}
            >
              <SelectItem className="dark" key={""}>Todos</SelectItem>
              <SelectItem className="dark" key={"1"}>Validado</SelectItem>
              <SelectItem className="dark" key={"0"}>No validado</SelectItem>
            </Select>
        ...
        <div className="w-3/4 space-y-4">
          ...
          {bills?.data?.data && (bills.data.data.map((bill : any) =>
            (<div key={bill.id}>
              <Link to={`/facturas/${bill.number}`}>
                <Card className="bg-gray-900 fac-card">
                  <CardHeader>
                    <div className="flex">
                      <h1 className="text-xl font-semibold text-gray-200">{bill.document.name} - {bill.number}</h1>
                    </div>
                  </CardHeader>
                  <Divider/>
                  <CardBody className="">
                    <div className="flex">
                      <div className="w-1/2">
                        ...
                        <div className="flex">
                          <b>Nombres:</b> <p className="ms-auto me-10">{bill.names}</p>
                        </div>
                        <div className="flex">
                          <b>CC:</b> <p className="ms-auto me-10">{bill.identification}</p>
                        </div>
                        <div className="flex">
                          <b>Email:</b> <p className="ms-auto me-10">{bill.email}</p>
                        </div>
                      </div>
                      <div className="w-1/2">
                        ...
                        <Divider className="my-4"/>
                        <h1 className="text-lg font-bold">Código de referencia</h1>
                    ...
                    <div className="flex">
                      ...
                      <p className="ms-auto me-10">{ bill.created_at ? bill.created_at : "No disponible"}</p>
                    </div>
                  </CardBody>
                </Card>
              </Link>
